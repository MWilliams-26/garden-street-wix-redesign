...
export const images = {
  hero: image('/images/classes/hero-ballet-class.webp','client-imports/photos-20260721/Photos/Classes/Belle Ballet 06_26_26 Edited (1)/DSC09066.jpg','Home','Hero','Young ballet students learning together in the Garden Street studio',2400,1600,{objectPosition:'50% 0%',mobileObjectPosition:'62% 50%',backup:['DSC09264.jpg','DSC09321.jpg']}),
  ...
  classBallet: image('/images/classes/ballet-class.webp','client-imports/photos-20260721/Photos/Classes/Belle Ballet 06_26_26 Edited (1)/DSC09164.jpg','Classes','Gallery','Ballet students practicing at the barre',2400,1600,{mobileObjectPosition:'50% 20%'}),
  classTeaching: image('/images/classes/teaching-portrait.webp','client-imports/photos-20260721/Photos/Classes/Belle Ballet 06_26_26 Edited (1)/DSC09393.jpg','Home, Classes','Instruction','Instructor supporting a young ballet student',2400,3601,{objectPosition:'50% 0%'}),
  classLeap: image('/images/classes/solo-leap.webp','client-imports/photos-20260721/Photos/Classes/Belle Ballet 06_26_26 Edited (1)/DSC09337.jpg','Classes, 404','Gallery','Dancer performing a leap in the studio',2400,1600,{objectPosition:'50% 20%',mobileObjectPosition:'50% 50%'}),
  owners: image('/images/staff/cory-victoria-johnson-owners-portrait.webp','assets/staff/web-ready/cory-victoria-johnson-owners-portrait.webp','Home, About','Owners','Garden Street owners Victoria and Cory Johnson',2388,2390,{objectPosition:'50% 38%',mobileObjectPosition:'50% 34%'}),
  ...
  emily: image('/images/staff/emily-derrick-headshot.webp','assets/staff/web-ready/emily-derrick-headshot.webp','About','Staff','Emily Derrick',378,644,{objectPosition:'50% 10%',mobileObjectPosition:'50% 0%'}),
  ...
  annamaria: image('/images/staff/annamaria-diamant-headshot.webp','assets/staff/web-ready/annamaria-diamant-headshot.webp','About','Staff','Annamaria Diamant',576,483,{objectPosition:'50% 25%',mobileObjectPosition:'50% 50%'}),
  bridget: image('/images/staff/bridget-bailey-headshot.webp','assets/staff/web-ready/bridget-bailey-headshot.webp','About','Staff','Bridget Bailey',1200,1200),
  maggie: image('/images/staff/maggie-cantwell-headshot.webp','assets/staff/web-ready/maggie-cantwell-headshot.webp','About','Staff','Maggie Cantwell',1200,1200),
  marissa: image('/images/staff/marissa-ferm-headshot.webp','assets/staff/web-ready/marissa-ferm-headshot.webp','About','Staff','Marissa Ferm',269,269),
  ...
  trollsTitle: image('/images/programs/trolls-kids-title-art.webp','assets/programs/musical-theatre/web-ready/trolls-kids-title-art.webp','Home, Musical Theatre','Program title art','Colorful theatrical title artwork for Trolls Kids',1200,800),
  wonkaTitle: image('/images/programs/willy-wonka-jr-title-art.webp','assets/programs/musical-theatre/web-ready/willy-wonka-jr-title-art.webp','Home, Musical Theatre','Program title art','Whimsical theatrical title artwork for Willy Wonka Jr.',1200,800),
  ...
  exterior: image('/images/studio/garden-street-building-exterior.webp','assets/studio/web-ready/garden-street-building-exterior.webp','Contact','Visit','Exterior of the Garden Street building on Washington Street',1175,1339,{objectPosition:'50% 44%'}),
  brandedWall: image('/images/studio/studio-a-branded-wall.webp','assets/studio/web-ready/studio-a-branded-wall.webp','Parties, Contact','Studio','Garden Street branded studio wall',1800,2400,{objectPosition:'50% 68%'}),
  ...
  backstage: image('/images/performances/musical-theatre-young-cast-backstage.webp','assets/performances/web-ready/musical-theatre-young-cast-backstage.webp','Home, Musical Theatre, Camps','Performance','Young musical theatre cast backstage',1200,1600,{objectPosition:'50% 20%',mobileObjectPosition:'50% 50%'}),
  ...
  advanced: image('/images/performances/recital-advanced-dancer-black-costume.webp','assets/performances/web-ready/recital-advanced-dancer-black-costume.webp','Camps','Performance','Advanced dancer performing in a black costume',749,480,{objectPosition:'50% 20%',mobileObjectPosition:'50% 50%'}),
