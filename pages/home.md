...
- **Page title:** Pending approved wording
- **Meta description:** Pending approved wording
- **URL slug:** `/`
...
Do not finalize claims until their source is recorded in `docs/content-inventory.md`.

## Responsive recommendations

### Desktop

Use clear hierarchy, concise pathways, and visible primary action without overcrowding the hero.

### Tablet

Preserve reading order and avoid narrow multi-column cards.

### Mobile

Lead with the key parent benefit and a large, immediate action; stack sections in priority order.
...
- [ ] CTA destinations recorded in `docs/studio-pro-links.md` when applicable.
- [ ] Copy approved.
